...
<head>
  ...
  <link rel="shortcut icon" href="../gambar/fav.png" type="image/png">
</head>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <img src="../gambar/deirma.png" class="logo" height="27%">
      </div>
        <h3 style="text-align: center; font-size: 45px; margin-top: 20px;">Sanggar Rias De'Irma</h3>
    </div>
    <!-- /.container-fluid-->
    <!-- /.content-wrapper-->
