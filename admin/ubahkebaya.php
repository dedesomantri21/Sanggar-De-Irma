...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  $que = mysqli_query($conn, "Select * from kebaya where kode_kebaya='$kode_kebaya'") or die(mysqli_error());
  $no = 1;
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ubah Data Kebaya</li>
      </ol>
      <div class="row">
        <div class="card card-register mx-auto mt-3" style="margin-bottom: 25px;">
      <div class="card-header"><b>Ubah Data Kebaya</b></div>
      <div class="card-body" style="width: 35rem;">
        <form action="pubahkebaya.php" method="post">
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                <label>Kode Kebaya :</label>
                <input class="form-control" type="text" name="kode_kebaya" value="<?php echo $data['kode_kebaya'];?>" readonly>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" type="text" name="jenis_kebaya" value="<?php echo $data['jenis_kebaya']; ?>">
              </div>
              <div class="col-md-6">
                <label>Ukuran :</label>
                <input class="form-control" type="text" name="ukuran" value="<?php echo $data['ukuran']; ?>">
              </div>
            </div>
          </div>
          <div class="form-group">
